...
<body background="try.jpg">
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><i id="left" class="fas fa-laugh-wink"></i> PHARMACY.KU</h3>
    ...
    echo " active";
        ...
        <footer class="text-center"><span>FARMASI.KU</span><br>©2020  All right reserved.</footer>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
                ...
                <div class="dashboard p-5">
                    <div class="total">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <a href="index.php?id=allManager">
                            ...
                            <div class="col-3">
                                <a href="index.php?id=allPharmacist">  
                                <div class="total__box text-center">
                                    <h1>
                                        <?php
